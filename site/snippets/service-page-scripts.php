<script>
  /* Reveal on scroll */
  (function () {
    var targets = document.querySelectorAll('.offering, .wovemind-related-card, .wovemind-highlight-card, .quote__inner, .team-member, .stat, .case-study-gallery, .service-card, .work-card, .work-grid-card, .testimonial__inner, .wovemind-card');
