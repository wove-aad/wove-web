<?php
/**
 * Digital service page — simplified filtered view
 * File: site/templates/digital.php
 */
...
<div class="feed-wrap">
  ...
  <div class="tag-hero">
    ...
    <p class="tag-hero__intro">Platforms and innovation that help you deliver and scale impact.</p>
  ...
  <section class="stream-section" aria-label="Digital work">
