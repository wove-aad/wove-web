<?php
/**
 * Labs service page — simplified filtered view
 * File: site/templates/labs.php
 */
...
<div class="feed-wrap">
  ...
  <div class="tag-hero">
    ...
    <p class="tag-hero__intro">Research and development for a more human future.</p>
  ...
  <section class="stream-section" aria-label="Labs work">
