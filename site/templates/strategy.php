<?php
/**
 * Strategy service page — simplified filtered view
 * File: site/templates/strategy.php
 */
...
<div class="feed-wrap">
  ...
  <div class="tag-hero">
    ...
    <p class="tag-hero__intro">Helping organisations plan, prioritise and change in lasting ways.</p>
  ...
  <section class="stream-section" aria-label="Strategy work">
